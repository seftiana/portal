...
$layout = new TLayout("print_bootstrap", "BoldBlueWave", "MobileBlueWave");
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "Kelas_ID_print";
...
$page_layouts["Kelas_ID_print"] = $layout;
...
$layout = new TLayout("masterprint_bootstrap", "BoldBlueWave", "MobileBlueWave");
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "s_semester_masterprint";
...
$page_layouts["s_semester_masterprint"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "s_krs_detil_print";
$layout->blocks["top"] = array();
$layout->containers["pdf"] = array();
$layout->container_properties["pdf"] = array(  "print" => "none"  );
$layout->containers["pdf"][] = array("name"=>"printbuttons",
...
$layout->blocks["top"][] = "grid";
$page_layouts["s_krs_detil_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Kelas ID" );
