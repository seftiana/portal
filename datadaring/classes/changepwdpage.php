...
class ChangePasswordPage extends RunnerPage
{
	...
	function __construct(&$params = "")
	{
		...
		$this->pSet = new ProjectSettings("s_user", $this->pageType);
	...
	protected function getSQLWhere()
	{
		...
		$sWhere = " where ".$this->connection->addFieldWrappers( $this->usernameField )."=".$value;
	...
	protected function checkToken()
	{
		...
		$sqlSelect = "select ".$this->connection->addFieldWrappers( "" )." from".$this->connection->addTableWrappers("s_user")
