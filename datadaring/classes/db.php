...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "gtakademik_dev_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "mahasiswa", "varname" => "gtakademik_dev_at_localhost__mahasiswa", "altvarname" => "mahasiswa", "connId" => "gtakademik_dev_at_localhost", "schema" => "", "connName" => "gtakademik_dev at localhost");
			$dalTables[$conn->connId][] = array("name" => "mahasiswa_akun", "varname" => "gtakademik_dev_at_localhost__mahasiswa_akun", "altvarname" => "mahasiswa_akun", "connId" => "gtakademik_dev_at_localhost", "schema" => "", "connName" => "gtakademik_dev at localhost");
			$dalTables[$conn->connId][] = array("name" => "program_studi", "varname" => "gtakademik_dev_at_localhost__program_studi", "altvarname" => "program_studi", "connId" => "gtakademik_dev_at_localhost", "schema" => "", "connName" => "gtakademik_dev at localhost");
			$dalTables[$conn->connId][] = array("name" => "s_dosen_kelas", "varname" => "gtakademik_dev_at_localhost__s_dosen_kelas", "altvarname" => "s_dosen_kelas", "connId" => "gtakademik_dev_at_localhost", "schema" => "", "connName" => "gtakademik_dev at localhost");
			$dalTables[$conn->connId][] = array("name" => "s_jadwal_kuliah", "varname" => "gtakademik_dev_at_localhost__s_jadwal_kuliah", "altvarname" => "s_jadwal_kuliah", "connId" => "gtakademik_dev_at_localhost", "schema" => "", "connName" => "gtakademik_dev at localhost");
			$dalTables[$conn->connId][] = array("name" => "s_kelas", "varname" => "gtakademik_dev_at_localhost__s_kelas", "altvarname" => "s_kelas", "connId" => "gtakademik_dev_at_localhost", "schema" => "", "connName" => "gtakademik_dev at localhost");
			$dalTables[$conn->connId][] = array("name" => "s_krs", "varname" => "gtakademik_dev_at_localhost__s_krs", "altvarname" => "s_krs", "connId" => "gtakademik_dev_at_localhost", "schema" => "", "connName" => "gtakademik_dev at localhost");
			$dalTables[$conn->connId][] = array("name" => "s_krs_detil", "varname" => "gtakademik_dev_at_localhost__s_krs_detil", "altvarname" => "s_krs_detil", "connId" => "gtakademik_dev_at_localhost", "schema" => "", "connName" => "gtakademik_dev at localhost");
			$dalTables[$conn->connId][] = array("name" => "s_matakuliah_kurikulum", "varname" => "gtakademik_dev_at_localhost__s_matakuliah_kurikulum", "altvarname" => "s_matakuliah_kurikulum", "connId" => "gtakademik_dev_at_localhost", "schema" => "", "connName" => "gtakademik_dev at localhost");
			$dalTables[$conn->connId][] = array("name" => "s_semester_prodi", "varname" => "gtakademik_dev_at_localhost__s_semester_prodi", "altvarname" => "s_semester_prodi", "connId" => "gtakademik_dev_at_localhost", "schema" => "", "connName" => "gtakademik_dev at localhost");
			$dalTables[$conn->connId][] = array("name" => "s_user", "varname" => "gtakademik_dev_at_localhost__s_user", "altvarname" => "s_user", "connId" => "gtakademik_dev_at_localhost", "schema" => "", "connName" => "gtakademik_dev at localhost");
		}
	}
