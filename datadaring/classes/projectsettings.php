...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "s_kelas" ] = array( "url" => "s_kelas", "type" => 0 );
	$projectEntitiesReverse[ "s_kelas" ] = "s_kelas";
	$projectEntities[ "s_krs_detil" ] = array( "url" => "s_krs_detil", "type" => 0 );
	$projectEntitiesReverse[ "s_krs_detil" ] = "s_krs_detil";
	$projectEntities[ "mahasiswa_akun" ] = array( "url" => "mahasiswa_akun", "type" => 0 );
	$projectEntitiesReverse[ "mahasiswa_akun" ] = "mahasiswa_akun";
}
