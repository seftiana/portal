...
function CustomExpression($value, $data, $field, $ptype, $table="")
{
	...
	if(!$table)
		$table = $strTableName;
				if($table=="s_kelas" && $field=="klsId")
	{
		$value="'".strval($value);;
		return $value;
	}
				if($table=="s_kelas" && $field=="dsnkDsnPegNip")
	{
		$value="'".$value;;
		return $value;
	}
				if($table=="s_krs_detil" && $field=="krsdtId")
	{
		$value="'".strval($value);;
		return $value;
	}
				if($table=="s_krs_detil" && $field=="krsMhsNiu")
	{
		$value="'".strval($value);;
		return $value;
	}
				if($table=="s_krs_detil" && $field=="krsId")
	{
		$value="'".strval($value);;
		return $value;
	}
