...
require_once("include/mahasiswa_akun_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "mahasiswa_akun_edit";
...
$page_layouts["mahasiswa_akun_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "mahasiswa_akun_list";
...
$page_layouts["mahasiswa_akun_list"] = $layout;
...
$keys = array();
$keys["maMhsNiu"] = postvalue("editid1");
