...
require_once("include/s_kelas_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "s_kelas_print";
...
$page_layouts["s_kelas_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "s_kelas" );
