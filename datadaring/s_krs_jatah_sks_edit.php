...
require_once("include/s_krs_jatah_sks_variables.php");
...
$layout = new TLayout("edit_bootstrap", "BoldBlueWave", "MobileBlueWave");
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "s_krs_jatah_sks_edit";
...
$page_layouts["s_krs_jatah_sks_edit"] = $layout;
...
$layout = new TLayout("list_bootstrap1", "BoldBlueWave", "MobileBlueWave");
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "s_krs_jatah_sks_list";
...
$page_layouts["s_krs_jatah_sks_list"] = $layout;
...
$keys = array();
$keys["krssksMhsNiu"] = postvalue("editid1");
$keys["krssksSempId"] = postvalue("editid2");
