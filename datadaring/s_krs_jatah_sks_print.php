...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "s_krs_jatah_sks_print";
...
$page_layouts["s_krs_jatah_sks_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "s_krs_jatah_sks" );
