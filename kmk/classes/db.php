...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "gtakademik_dev_at_localhost" == $conn->connId )
		{
			...
			$dalTables[$conn->connId][] = array("name" => "mahasiswa_registrasi", "varname" => "gtakademik_dev_at_localhost__mahasiswa_registrasi", "altvarname" => "mahasiswa_registrasi", "connId" => "gtakademik_dev_at_localhost", "schema" => "", "connName" => "gtakademik_dev at localhost");
			...
			$dalTables[$conn->connId][] = array("name" => "status_aktif_mahasiswa_ref", "varname" => "gtakademik_dev_at_localhost__status_aktif_mahasiswa_ref", "altvarname" => "status_aktif_mahasiswa_ref", "connId" => "gtakademik_dev_at_localhost", "schema" => "", "connName" => "gtakademik_dev at localhost");
		}
		if( "alluser_at_103_119_146_35" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "pengguna", "varname" => "alluser_at_103_119_146_35__pengguna", "altvarname" => "pengguna", "connId" => "alluser_at_103_119_146_35", "schema" => "", "connName" => "alluser at 103.119.146.35");
		}
	}
