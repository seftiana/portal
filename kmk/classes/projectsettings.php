...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "mahasiswa_registrasi" ] = array( "url" => "mahasiswa_registrasi", "type" => 0 );
	$projectEntitiesReverse[ "mahasiswa_registrasi" ] = "mahasiswa_registrasi";
	$projectEntities[ "mahasiswa" ] = array( "url" => "mahasiswa", "type" => 0 );
	$projectEntitiesReverse[ "mahasiswa" ] = "mahasiswa";
	$projectEntities[ "pengguna" ] = array( "url" => "pengguna", "type" => 0 );
	$projectEntitiesReverse[ "pengguna" ] = "pengguna";
	$projectEntities[ "status_aktif_mahasiswa_ref" ] = array( "url" => "status_aktif_mahasiswa_ref", "type" => 0 );
	$projectEntitiesReverse[ "status_aktif_mahasiswa_ref" ] = "status_aktif_mahasiswa_ref";
}
