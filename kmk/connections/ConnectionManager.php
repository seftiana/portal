...
class ConnectionManager
{
	...
	{
		return $this->byId( "gtakademik_dev_at_localhost" );
	}
	...
	{
		return $this->byId( "alluser_at_103_119_146_35" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "gtakademik_dev_at_localhost";
		$data["connName"] = "gtakademik_dev at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;gtakademik_dev;;1"; //currently unused

		$this->_connectionsIdByName["gtakademik_dev at localhost"] = "gtakademik_dev_at_localhost";
...
;
		...
		$connectionsData["gtakademik_dev_at_localhost"] = $data;
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "alluser_at_103_119_146_35";
		$data["connName"] = "alluser at 103.119.146.35";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;103.119.146.35;superU;Perbana5_7ay4;;alluser;;1"; //currently unused

		$this->_connectionsIdByName["alluser at 103.119.146.35"] = "alluser_at_103_119_146_35";
		
		$data["connInfo"] = array();
		$data["ODBCUID"] = "superU";
		$data["ODBCPWD"] = "Perbana5_7ay4";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
...
;
		...
		$connectionsData["alluser_at_103_119_146_35"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["mahasiswa_registrasi"] = "gtakademik_dev_at_localhost";
		$connectionsIds["mahasiswa"] = "gtakademik_dev_at_localhost";
		$connectionsIds["pengguna"] = "alluser_at_103_119_146_35";
		$connectionsIds["status_aktif_mahasiswa_ref"] = "gtakademik_dev_at_localhost";
