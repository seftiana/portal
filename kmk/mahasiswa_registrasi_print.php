...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "mahasiswa_registrasi_print";
...
$page_layouts["mahasiswa_registrasi_print"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "mahasiswa_masterprint";
...
$page_layouts["mahasiswa_masterprint"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "mahasiswa_registrasi" );
