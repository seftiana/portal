...
$layout = new TLayout("view_bootstrap_2col", "BoldBlueWave", "MobileBlueWave");
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "mahasiswa_registrasi_view";
...
$page_layouts["mahasiswa_registrasi_view"] = $layout;
...
$layout = new TLayout("masterlist_bootstrap", "BoldBlueWave", "MobileBlueWave");
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "mahasiswa_masterlist";
...
$page_layouts["mahasiswa_masterlist"] = $layout;
...
$keys = array();
$keys["mhsregSemId"] = postvalue("editid1");
