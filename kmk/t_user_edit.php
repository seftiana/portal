...
require_once("include/t_user_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "t_user_edit";
...
$page_layouts["t_user_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "t_user_list";
...
$page_layouts["t_user_list"] = $layout;
...
$keys = array();
$keys["tusrNama"] = postvalue("editid1");
