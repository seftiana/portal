   ...
   */
   ...
   class AcademicPlanClientService extends SIASettingClientService {
	...
	#add ccp 11-9-2019
	  ...
	  #add ccp 1-12-2025
	  function DoGetPresensiQr($mhsNiu,$qr){
         $this->mReqServiceParams['pAct'] = "DoGetPresensiQr";
         $dataParams = array($mhsNiu,$qr);
         $serviceParams = array($this->mReqServiceParams, $dataParams);
         $result = $this->Call("Dispatch", $serviceParams);
         return $result;
      }
	  
	  function DoUpdatePresensiQr($mhsNiu,$uuid) {
         $this->mReqServiceParams['pAct'] = "DoUpdatePresensiQr";
         $dataParams = array($mhsNiu,$uuid);
         $serviceParams = array($this->mReqServiceParams, $dataParams);
         $result = $this->Call("Dispatch", $serviceParams);
	  ...
	  function DoInsertPresensiQr($mhsNiu,$uuid) {
         $this->mReqServiceParams['pAct'] = "DoInsertPresensiQr";
         $dataParams = array($mhsNiu,$uuid);
         $serviceParams = array($this->mReqServiceParams, $dataParams);
         $result = $this->Call("Dispatch", $serviceParams);
