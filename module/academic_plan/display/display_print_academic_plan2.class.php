...
*/
class DisplayPrintAcademicPlan2 extends DisplayBasePrint {
   ...
   function DisplayPrintAcademicPlan2(&$configObject, &$security, $userRole, $mhsniu, $prodiId) {
      ...
      $this->SetTemplateFile('print_academic_plan2.html');
   }
