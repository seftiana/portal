<?php
   ...
   require_once $cfg->GetValue("app_module") . "academic_plan/display/display_view_jadwal.class.php" ;  
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
      ...
      $ThisPage = new DisplayViewJadwal($cfg, $security, $userRole, $mhsNiu, $prodiId, $errMsg, $viewBy, $siaaddr,$getBlock); #update ccp 9-juli-2019
