<?php
/**
 * DisplayPrintGradeHistory
 * DisplayPrintGradeHistory class
 * 
...
class DisplayPrintGradeHistory extends DisplayBasePrint {
   var $mMahasiswaNiu;
   var $mMahasiswaProdi;

   
   function DisplayPrintGradeHistory(&$configObject, &$security, $mhsniu, $mhsprodi) {
      ...
      $this->SetTemplateFile('print_grade_history.html');
   }
            ...
            foreach ($dataNilai as $key=>$value) {
               ...
               foreach ($arrKeTemp as $keyKe=>$keValue) {
                  ...
                  if (isset($arrNilaiTemp[$keyKe])){
                     $NilaiTemp[$loop][$urutanNilai] = $arrNilaiTemp[$keyKe];
                  } else {
