<?php
   ...
   require_once $cfg->GetValue("app_module") . "academic_report/display/display_print_transcript.class.php" ;  
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
      ...
      $ThisPage = new DisplayPrintTranscript($cfg, $security, $mhsNiu, $prodiId);
