...
require_once $cfg->GetValue("app_module") . "academic_report/display/display_print_transcript3.class.php" ;
...
if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
   ...
   $ThisPage = new DisplayPrintTranscript3($cfg, $security, $mhsNiu, $prodiId);
