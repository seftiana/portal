<?php
   ...
   require_once $cfg->GetValue("app_module") . "academic_report/display/display_view_khs.class.php" ;  
   ...
   $getSurvei = $cfg->GetValue('enable_survei'); #add ccp 20-01-2023
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
      ...
      $ThisPage = new DisplayViewKHS($cfg, $security, $mhsNiu, $prodiId, $sempId, $errMsg, $viewBy, $siaaddr, $getBlock, $getSurvei); #update ccp 6-3-2019
