<?php
   ...
   require_once $cfg->GetValue("app_module") . "account/display/display_view_account_email.class.php" ;  
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
      ...
      $ThisPage = new DisplayViewAccountEmail($cfg, $security, $userRole, $mhsNiu, $prodiId, $errMsg, $viewBy, $siaaddr);
