<?php
   ...
   /**
     * DisplayViewUserAcademicAnnouncement
     * Display Class for View Academic Announcement for User
     * 
     * @package DisplayViewUserAcademicAnnouncement
     ...
     *
     */
   class DisplayViewUserAcademicAnnouncement extends DisplayBaseFull
   {
      /**
      ...
      /**
        * DisplayViewUserAcademicAnnouncement::DisplayViewUserAcademicAnnouncement
        ...
        * @return void
        */
      function DisplayViewUserAcademicAnnouncement(&$configObject, &$security, $page)
      {
         ...
         $this->SetTemplateFile('view_academic_announcement.html');
      }
      
      /**
        * DisplayViewUserAcademicAnnouncement::GetDataAnnouncement
      ...
      function GetDataAnnouncement($start, $limit) {         
         ...
         if(false === $dataUser) {
            ...
            if ($dataUser[0]['nama'] == "admin"){
               return $this->mDataAnnouncement->GetInformationByType(1, $limit,$start);
            }
            else {
               $this->mDataAnnouncement->SetProperty("AnnouncementTypeId", 1);
      ...
      /**
        * DisplayViewUserAcademicAnnouncement::GetCountDataAnnouncement
      ...
      /**
        * DisplayViewUserAnnouncement::Display
      ...
      function Display()
      {
         ...
         $this->AddVar("content", "APPLICATION_MODULE", 'Informasi Akademik');             
