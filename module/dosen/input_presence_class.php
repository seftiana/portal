<?php
   ...
   require_once $cfg->GetValue("app_module") . "dosen/display/display_input_presence_class.class.php" ; 
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
	  ...
	  $ThisPage = new DisplayInputPresenceClass($cfg, $security, $semesterId, $kelasId, $pertemuanId, $errMsg);
