   ...
   require_once $cfg->GetValue("app_module") . "dosen/display/display_print_grade_management.class.php" ;  
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
	...
	//end
      ...
      $ThisPage = new DisplayPrintGradeManagement($cfg, $security, $errMsg, $semester, $kelasId, $sia, $halaman, $nif, $afterProc, $prodi_kode_kelas); //add cecep 10 maret 2017
