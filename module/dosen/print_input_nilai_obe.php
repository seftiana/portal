   ...
   require_once $cfg->GetValue("app_module") . "dosen/display/display_print_input_nilai_obe.class.php" ;  
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
	...
	//end
      ...
      $ThisPage = new DisplayPrintInputNilaiObe($cfg, $security, $errMsg, $semester, $kelasId, $sia, $halaman, $nif, $afterProc, $prodi_kode_kelas); //add cecep 10 maret 2017
