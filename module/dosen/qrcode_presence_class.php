<?php
   ...
   require_once $cfg->GetValue("app_module") . "dosen/display/display_qrcode_presence_class.class.php" ; 
   
   //Konek Ke gtPembayaran add ccp 24-8-2019   
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
	  ...
	  $ThisPage = new DisplayQrcodePresenceClass($cfg, $security, $semesterId, $kelasId, $pertemuanId, $errMsg);
