...
// Load Application Display Class	   
   ...
   require_once $cfg->GetValue('app_module') . 'e_materi/display/display_detail_materi.class.php';
...
if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
    ...
    $app = new DisplayDetailMateri($cfg,$security,$id);
    $app->SetLinks($lnk);
    $app->SetTemplateFile('detail_materi_tampil.html');
