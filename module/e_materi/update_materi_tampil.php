...
// Load Application Display Class	   
   ...
   require_once $cfg->GetValue('app_module') . 'e_materi/display/display_update_materi.class.php';
...
if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
    ...
    $app = new DisplayUpdateMateri($cfg,$security,$id);
    $app->SetLinks($lnk);
    $app->SetTemplateFile('update_materi_tampil.html');
