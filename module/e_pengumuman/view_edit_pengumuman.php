<?php
   ...
   require_once $cfg->GetValue("app_module") . "e_pengumuman/display/display_view_edit_pengumuman.class.php" ;    
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
	  ...
	  //print_r($_GET);
      $ThisPage = new DisplayViewEditPengumuman($cfg, $security, $pgmnId);      
