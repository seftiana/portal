<?php
   ...
   require_once $cfg->GetValue('app_module') . 'e_tugas/display/display_add_jenis_tugas.class.php';
...
if (false !== $security->CheckAccessRight($ThisPageAccessRight))
{
	...
	$app = new DisplayAddJenisTugas($cfg,$security,$id);
	$app->SetLinks($lnk);
	$app->SetTemplateFile('add_jenis_tugas_tampil.html');
	$app->Display();
}
else
{
