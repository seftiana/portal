<?php
   ...
   require_once $cfg->GetValue('app_module') . 'e_tugas/display/display_detail_tugas.class.php';
...
if (false !== $security->CheckAccessRight($ThisPageAccessRight))
{
	...
	$id = $cfg->Dec(htmlspecialchars($_GET['id']));	
	$app = new DisplayDetailTugas($cfg,$security,$id);
	$app->SetLinks($lnk);
	$app->SetTemplateFile('detail_tugas_tampil.html');
	$app->Display();
}
else
{
