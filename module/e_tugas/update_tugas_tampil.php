<?php
   ...
   require_once $cfg->GetValue('app_module') . 'e_tugas/display/display_update_tugas.class.php';
...
if (false !== $security->CheckAccessRight($ThisPageAccessRight))
{
	...
	$app = new DisplayUpdateTugas($cfg,$security,$id);
	$app->SetLinks($lnk);
	$app->SetTemplateFile('update_tugas_tampil.html');
	$app->Display();
}
else
{
