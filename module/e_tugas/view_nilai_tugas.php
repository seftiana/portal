<?php
   ...
   require_once $cfg->GetValue('app_module') . 'e_tugas/display/display_nilai_tugas.class.php';
...
if (false !== $security->CheckAccessRight($ThisPageAccessRight))
{
	...
	$app = new DisplayNilaiTampil($cfg,$security,$id);
	$app->SetLinks($lnk);
	$app->SetTemplateFile('nilai_tampil.html');
	$app->Display();
}
else
{
