...
//Load module Display Faq
   require_once $cfg->GetValue('app_module') . 'faq/display/display_view_faq_kategori.class.php';
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)) {
      ...
      $ThisPage = new DisplayViewFaqKategori($cfg, $security, $hal, $errMsg, $tErrMsg);
