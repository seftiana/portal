<?php
   ...
   class DisplayViewSaran extends DisplayBaseFull
   {
      var $mDataForum;
      ...
      function DisplayViewSaran(&$configObject, &$security, $katid, $topid, $isManaged, $page, $error, $errorType)
      {
         ...
         if ($this->mIsManaged)
            ...
            $this->SetTemplateFile('view_saran.html');
      ...
      function Display()
      {
         ...
         // $this->AddVar("content", "URL_ADD_PROCESS", $this->mrConfig->GetURL('forum', 'forum', 'process'));
			...
			$url = $this->mrConfig->GetURL('forum', 'saran', 'view') . 
