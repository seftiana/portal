<?php
   ...
   require_once $cfg->GetValue('app_module') . 'forum/display/display_update_thread.class.php';
   ...
   require_once $cfg->GetValue('app_module') . 'forum/business/forum.class.php';
	...
	if (false !== $security->CheckAccessRight($ThisPageAccessRight)) {
      ...
      if(isset($_GET['thrdid']))
		...
		$ThisPage = new DisplayUpdateThread($cfg, $security, $katid, $topid, $threadid, $err, $errtype);
