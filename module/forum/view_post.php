<?php
   ...
   require_once $cfg->GetValue('app_module') . 'forum/display/display_view_post.class.php';
   ...
   require_once $cfg->GetValue('app_module') . 'forum/business/forum.class.php';
	...
	if (false !== $security->CheckAccessRight($ThisPageAccessRight)) {
      ...
      if(isset($_GET['thrdid']))
		...
		$pg = 1;
      if(isset($_GET['page']))
         $pg = $cfg->Dec($_GET['page']);
         
		$ThisPage = new DisplayViewPost($cfg, $security, $katid, $topid, $threadid, $isManaged, $pg, $err, $errtype);
