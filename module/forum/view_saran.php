<?php
   ...
   require_once $cfg->GetValue('app_module') . 'forum/display/display_view_saran.class.php';
   ...
   require_once $cfg->GetValue('app_module') . 'forum/business/forum.class.php';
	...
	if (false !== $security->CheckAccessRight($ThisPageAccessRight)) {
      ...
      if(isset($_GET['page']))
		...
		$ThisPage = new DisplayViewSaran($cfg, $security, $katid, $topid, $isManaged, $page, $err, $errtype);
