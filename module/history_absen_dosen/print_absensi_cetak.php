   ...
   require_once $cfg->GetValue("app_module") . "history_absen_dosen/display/display_print_absensi_cetak.class.php" ;  
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
      ...
      $ThisPage = new DisplayPrintAbsenCetak($cfg, $security, $errMsg, $semester, $kelasId, $sia, $halaman, $nif, $afterProc); //add cecep 10 maret 2017
