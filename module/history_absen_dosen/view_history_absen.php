<?php
   ...
   require_once $cfg->GetValue("app_module") . "history_absen_dosen/display/display_view_history_absen.class.php";  
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
      ...
      $ThisPage = new DisplayViewHistoryAbsen($cfg, $security, $dsnNip, $prodiId, $viewFrom, $semesterId, $servServer, $errMsg);
