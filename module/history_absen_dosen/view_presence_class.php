<?php
   ...
   require_once $cfg->GetValue("app_module") . "history_absen_dosen/display/display_view_presence_class.class.php" ; 
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
      ...
      $ThisPage = new DisplayViewPresenceClass($cfg, $security, $semesterId, $kelasId, $servServer, $errMsg);
