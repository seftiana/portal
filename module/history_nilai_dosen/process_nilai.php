   ...
   $security = new Security($cfg);
	...
	if (false !== $security->CheckAccessRight($ThisPageAccessRight)) {
        ...
        if(isset($_POST['btnLihat'])) {
            // lihat nilai 
            header("Location: " . $cfg->GetURL('history_nilai_dosen','kelas_nilai','view') . $urlAdditional . '&sem=' . $_POST['lstSemester']);
        } else {
            header("Location: " . $cfg->GetURL('history_nilai_dosen','kuisioner_dosen','view') . $urlAdditional);
        }
