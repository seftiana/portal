<?php
   ...
   require_once $cfg->GetValue("app_module") . "history_nilai_dosen/display/display_view_history_nilai.class.php";  
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
      ...
      $ThisPage = new DisplayViewHistoryNilai($cfg, $security, $dsnNip, $prodiId, $viewFrom, $semesterId, $servServer, $errMsg);
