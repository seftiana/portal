<?php
   ...
   require_once $cfg->GetValue("app_module") . "history_nilai_dosen/display/display_view_kelas_nilai.class.php" ;  
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
      ...
      $ThisPage = new DisplayViewKelasNilai($cfg, $security, $dsnNip, $prodiId, $viewFrom, $semesterId, $servServer, $errMsg);
