   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)) {
      ...
      if(isset($_POST['action']) AND  $_POST['action'] == 'viewMatKulDiampuFromNilai') {
         ...
         if (isset($_POST['btnUbah'])) {
            ...
            # Update Nilai
            $result = $app->DoUpdateNilaiCpmk($arrKrsId, $_POST['nilai'], $semId, $_POST['niu'],$kodeProdi);
			...
			$result = $result && $app->DoUpdateDpnaCpmk($_POST);
            $urlAdditional = '&smt=' . $_POST['smt'] . '&kelas=' . $_POST['kls'] . '&pkk=' . $_POST['kodeProdi'] .'&sia=' . $_POST['sia'];
            if ($result === false) {
            ...
            header("Location: " . $cfg->GetURL('history_nilai_obe','input_perbaikan','view') . $urlAdditional);
            ...
            header("Location: " . $cfg->GetURL('history_nilai_obe','kelas_nilai','view') . '&sia=' . $_POST['sia']  . '&sem=' . $_POST['smt']);
         } else {
            header("Location: " . $cfg->GetURL('history_nilai_obe','kelas_nilai','view') . '&sia=' . $_POST['sia']  . '&sem=' . $_POST['smt']);
         }
       }else {
