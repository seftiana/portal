   ...
   require_once $cfg->GetValue("app_module") . "history_nilai_obe/display/display_view_grade_management.class.php" ;  
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
	  ...
	  $subCpmk = "";
      if (isset($_GET["cpmk"])){
         $subCpmk = $cfg->Dec($_GET["cpmk"]);
      }
	  
      $ThisPage = new DisplayViewGradeManagement($cfg, $security, $errMsg, $semester, $kelasId, $sia, $afterProc, $prodi_kode_kelas,$subCpmk); //add cecep 10 maret 2017
