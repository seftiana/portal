   ...
   require_once $cfg->GetValue("app_module") . "history_nilai_obe/display/display_view_input_perbaikan.class.php" ;  
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
      ...
      $ThisPage = new DisplayViewInputPerbaikan($cfg, $security, $errMsg, $semester, $kelasId, $sia, $afterProc, $prodi_kode_kelas,$subCpmk);
