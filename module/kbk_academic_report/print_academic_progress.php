<?php
   ...
   require_once $cfg->GetValue("app_module") . "academic_report/display/display_print_progress.class.php" ;  
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
      ...
      $ThisPage = new DisplayPrintProgress($cfg, $security, $mhsNiu, $prodiId);
