<?php
   ...
   require_once $cfg->GetValue("app_module") . "kbk_academic_report/display/display_print_khs_01.class.php" ;  
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
      ...
      $ThisPage = new DisplayPrintKHS($cfg, $security, $mhsNiu, $prodiId, $sempId);
