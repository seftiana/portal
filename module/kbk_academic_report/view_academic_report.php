<?php
   ...
   require_once $cfg->GetValue("app_module") . "kbk_academic_report/display/display_view_khs.class.php" ;  
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
      ...
      $ThisPage = new DisplayViewKHS($cfg, $security, $mhsNiu, $prodiId, $sempId, $errMsg, $viewBy, $siaaddr);
