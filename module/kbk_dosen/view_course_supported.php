<?php
   ...
   require_once $cfg->GetValue("app_module") . "kbk_dosen/display/display_view_course_supported.class.php" ;  
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
      ...
      $ThisPage = new DisplayViewCourseSupported($cfg, $security, $dsnNip, $prodiId, $viewFrom, $semesterId, $servServer, $errMsg);
