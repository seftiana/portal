...
require_once $cfg->GetValue('app_module') . 'kbk_dosen/display/display_view_matakuliah_diampu_detil.class.php';
...
$ThisPageAccessRight = "DOSEN_KBK"; 
   ...
   { 
      ...
      $app = new DisplayViewMatakuliahDiampuDetil($cfg, $security, $dsnNip, $klsId, $prodiId);
      $app->SetLinks($lnk);  
      $app->Display(); 
   } 
   else 
