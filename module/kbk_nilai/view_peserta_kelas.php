...
require_once $cfg->GetValue('app_module') . 'kbk_nilai/display/display_view_peserta_kelas.class.php';
...
$ThisPageAccessRight = "MAHASISWA_KBK | DOSEN_KBK"; 
   ...
   { 
      ...
      $app = new DisplayViewPesertaKelas($cfg, $security,$nim,$prodiId,$sempId,$klsId);
      //$app->SetLinks($lnk);  
      $app->Display(); 
   } 
   else 
