...
class DisplayViewProposedClassesDetail extends DisplayBaseFull {
   ...
   function DisplayViewProposedClassesDetail(&$configObject, &$security, $kelasId, $errMsg, $serviceServer="", $module="", $param="", $value="") {
      ...
      if ($module != ""){
         ...
         $this->mModule = $this->mrConfig->Enc('kbk_proposed_classes|proposed_classes_semester|view');
      }
   ...
   function Display() {
      ...
      $this->AddVar("content", "URL_BACK", $this->mrConfig->GetURL('kbk_proposed_classes','proposed_classes','process'));
