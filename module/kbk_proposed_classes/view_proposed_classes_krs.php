<?php
   ...
   require_once $cfg->GetValue("app_module") . "kbk_proposed_classes/display/display_view_proposed_classes_krs.class.php" ;  
   ...
   if (isset($_GET['id'])){
    ...
    if (false !== $security->CheckAccessRight($ThisPageAccessRight) AND $id == 'krs'){
      ...
      $ThisPage = new DisplayViewProposedClassesKrs($cfg, $security, $ThisPageLinks, $mhsNiu, $prodiId, $errMsg, $sia, $view);
