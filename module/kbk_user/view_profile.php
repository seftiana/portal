<?php
   ...
   // Load Module Class  
   require_once $cfg->GetValue('app_module') . 'kbk_user/display/display_view_profile.class.php';
   require_once $cfg->GetValue('app_module') . 'kbk_user/communication/user_client.service.class.php';
   
   
   $ThisPageAccessRight = "MAHASISWA | DOSEN | MAHASISWA_KBK | DOSEN_KBK";
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
      ...
      $ThisPage = new DisplayViewProfile($cfg, $security, $userId, $userRole, $viewBy, $siaaddr);
