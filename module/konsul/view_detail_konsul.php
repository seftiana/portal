<?php
   ...
   require_once $cfg->GetValue('app_module') . 'konsul/display/display_view_detail_konsul.class.php';
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)) {
      ...
      $ThisPage = new DisplayViewDetailKonsul($cfg, $security, $msgId, $msgType, $errAddrBook, $errType);
