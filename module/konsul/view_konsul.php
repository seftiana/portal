<?php
   ...
   require_once $cfg->GetValue('app_module') . 'konsul/display/display_view_konsul.class.php';
   require_once $cfg->GetValue('app_module') . 'konsul/business/konsul.class.php';
	...
	if (false !== $security->CheckAccessRight($ThisPageAccessRight)) {
      ...
      if (isset($_GET['page']))
		...
		$ThisPage = new DisplayViewKonsul($cfg, $security, $msgType, $errMsg, $errType, $page,$ThisPageLinks);
