<?php
   ...
   require_once $cfg->GetValue("app_module") . "kuisioner/display/display_informasi_pemilu.class.php" ; 
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
      ...
      $ThisPage = new DisplayInformasiPemilu($cfg, $security, $niu, $servServer, $errMsg); //update ccp 12-02-2019 23-10-2018
      $ThisPage->Display();
   }else{
