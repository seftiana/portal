<?php
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
      ...
      if (isset($_GET["err"])){
		...
		$semIdKuis = $dateInputNilai[0]['SEM_ID']; //add ccp 12-02-2019
		//echo $waktu;die;
		//end
      $ThisPage = new DisplayKuisioner($cfg, $security, $niu, $servServer, $errMsg, $waktu, $semIdKuis); //update ccp 12-02-2019 23-10-2018
      $ThisPage->Display();
   }else{
