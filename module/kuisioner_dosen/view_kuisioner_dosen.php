<?php
   ...
   require_once $cfg->GetValue("app_module") . "kuisioner_dosen/display/display_view_kuisioner_dosen.class.php" ;  
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
      ...
      $ThisPage = new DisplayViewKuisionerDosen($cfg, $security, $dsnNip, $prodiId, $viewFrom, $semesterId, $servServer, $errMsg);
