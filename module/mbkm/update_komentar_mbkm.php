<?php
   ...
   require_once $cfg->GetValue('app_module') . 'mbkm/display/display_update_komentar_mbkm.class.php';
   ...
   ##end####
	...
	if (false !== $security->CheckAccessRight($ThisPageAccessRight)) {
		...
		$ThisPage = new DisplayUpdateKomentarMbkm($cfg, $security, $errMsg, $id, $cari);
