<?php
   ...
   /**
     * DisplayViewComposeMessage
     * Display Class for View Compose Message 
     * 
     * @package DisplayViewComposeMessage
     ...
     *
     */
   class DisplayViewComposeMessage extends DisplayBaseFull
   {
      /**
      ...
      /**
        * DisplayViewComposeMessage::DisplayViewComposeMessage
        * Constructor for Class DisplayViewComposeMessage
        *
        ...
        * @return void
        */
      function DisplayViewComposeMessage(&$configObject, &$security, $composeType, $errMsg, $errType, $msgId)
      {
         ...
         $this->SetTemplateFile('view_compose_message.html');
      }
      
      /**
        * DisplayViewComposeMessage::Display
      ...
      function Display()
      {
         ...
         if ($this->mComposeType == 'Forward')
            $tipe = "Lanjutkan";
         $this->AddVar("content", "APPLICATION_SUBMODULE",$tipe. ' Pesan');
