<?php
   ...
   /**
     * DisplayViewDetailMessage
     * Display Class for View Detail Message
     * 
     * @package DisplayViewDetailMessage
     ...
     *
     */
   class DisplayViewDetailMessage extends DisplayBaseFull
   {
      /**
      ...
      /**
        * DisplayViewDetailMessage::DisplayViewDetailMessage
        * Constructor for Class DisplayViewDetailMessage
        *
        ...
        * @return void
        */
      function DisplayViewDetailMessage(&$configObject, &$security, $msgId, $msgType, $errAddrBook, $errType)
      {
         ...
         $this->SetTemplateFile('view_detail_message.html');
      }
      
      /**
        * DisplayViewDetailMessage::Display
      ...
      function Display()
      {
         ...
         $this->AddVar("content", "APPLICATION_SUBMODULE", 'Detail Pesan');
         ...
         if (!empty($this->mMessageId)) {
            ...
            if (false === $detailMessage) {
               ...
               //$this->AddVar("message_detail","URL_KEMBALI",$this->mrConfig->GetURL('message','message','view') . "&msgType=". $this->mrConfig->Enc($this->mMessageType));
            }
            else {
               ...
               $detailMessage[0]['url_Kembali'] = $this->mrConfig->GetURL('message','message','view') . "&msgType=". $this->mrConfig->Enc($this->mMessageType);
               //$detailMessage[0]['url_action'] = $this->mrConfig->GetURL('message','message','process');
            
               $this->ParseData("message_detail", $detailMessage, "MSG_");
               $this->AddVar("content","URL_ACTION",$this->mrConfig->GetURL('message','message','process'));
            }
         }
