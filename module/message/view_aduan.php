<?php
   ...
   require_once $cfg->GetValue('app_module') . 'message/display/display_view_aduan.class.php';
   require_once $cfg->GetValue('app_module') . 'message/business/message.class.php';
	...
	if (false !== $security->CheckAccessRight($ThisPageAccessRight)) {
      ...
      if (isset($_GET['page']))
		...
		$ThisPage = new DisplayViewAduan($cfg, $security, $msgType, $errMsg, $errType, $page);
