<?php
   ...
   require_once $cfg->GetValue('app_module') . 'message/display/display_view_compose_message.class.php';
   require_once $cfg->GetValue('app_module') . 'message/business/message.class.php';
	...
	if (false !== $security->CheckAccessRight($ThisPageAccessRight)) {
      ...
      if (isset($_GET['msgId']))
		...
		$ThisPage = new DisplayViewComposeMessage($cfg, $security, $composeType, $errMsg, $errType, $msgId);
