<?php
   ...
   require_once $cfg->GetValue("app_module") . "payment/display/display_view_bill_information_detil.class.php" ; 
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
      ...
      $ThisPage = new DisplayViewBillInformationDetil($cfg, $security, $userRole, $mhsNiu, $prodiId, $errMsg, $viewBy, $siaaddr);
