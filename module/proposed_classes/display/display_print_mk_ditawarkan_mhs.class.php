...
Date : 6/10/2014 7:32:41 PM
*/
class DisplayPrintMkDitawarkanMhs extends DisplayBasePrint {
   ...
   function DisplayPrintMkDitawarkanMhs(&$configObject, &$security) {
      ...
      $this->SetTemplateFile('print_mk_ditawarkan_mhs.html');
   }
   ...
   function Display () {
      ...
      $listSemuaMk = $this->mObjProposedClasses->getListMkDitawarkanMhs($this->mUserId);
      $dataMhs = $this->mObjProposedClasses->getDataMhs($this->mUserId);

      $sesiKrsSelesai = $this->mObjProposedClasses->mSemesterProdiTanggalKrsSelesai;
      $sesiKrsSelesai = $this->ubahFormatTanggal($sesiKrsSelesai);
      ...
      $this->AddVar('page','MHS_NIM',$dataMhs['mhsNiu']);
      $this->AddVar('page','MHS_NAMA',$dataMhs['mhsNama']);
      $this->mTemplate->addVar('page','DOSEN_WALI',$dataMhs['dosenWali']);
      $this->mTemplate->addVar('page','SESI_KRS_SELESAI',$sesiKrsSelesai);
      ...
      $this->mTemplate->addVar('document','DOSEN_WALI',$dataMhs['dosenWali']);
      $this->mTemplate->addVar('document','MHS_NAMA',$dataMhs['mhsNama']);
   ...
   function ubahFormatTanggal($tglnya){
      $arrayTgl = explode('-',$tglnya);
      return $arrayTgl[2].'/'.$arrayTgl[1].'/'.$arrayTgl[0];
   }
}
?>