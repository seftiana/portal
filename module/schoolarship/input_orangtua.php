<?php
   ...
   require_once $cfg->GetValue("app_module") . "schoolarship/display/display_input_orangtua.class.php" ;  
   ...
   $security = new Security($cfg);
	if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
      ...
      $orangtuaId= "";
      if (isset($_GET['ortu'])) {
			$orangtuaId = $cfg->Dec($_GET['ortu']);
		}

          
      $ThisPage = new DisplayInputOrangtua($cfg, $security, $beasiswaId, $orangtuaId, $error);
