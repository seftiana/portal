<?php
set_time_limit(0);
class DisplayEditMahasiswa extends DisplayBaseFull 
{
    ...
    * @return void
    */
   function DisplayEditMahasiswa(&$configObject, $securityObj, $userId, $userRole, $viewBy, $siaServer) 
   {
      ...
      $this->SetTemplateFile('view_edit_mhs.html');
   }
   ...
   { 
		...
		$this->AddVar("data_biodata", "URL_KEMBALI", $this->mrConfig->GetURL('user', 'profile2', 'view'));
		...
		$referensi = $this->mSiregService->GetListReferensiMahasiswa();
		  ...
		  $biodata = $UserService->GetBiodataMhs($this->mUserId);//print_r($biodata);die;
