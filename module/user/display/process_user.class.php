 ...
 */
   ...
   class ProcessUser extends ProcessBase 
   {
      /**
      ...
      * Constructor for ProcessUser class
      *
      * @param $configObject object Configuration
      * @return void
      */
      function ProcessUser($configObject,$siaService) 
      {
      ...
      /**
       * ProcessUser::GenerateNewPassword
      ...
      /**
       * ProcessUser::UpdateUserPassword
      ...
      /**
       * ProcessUser::UpdateUserAgreement
