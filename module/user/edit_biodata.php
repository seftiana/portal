<?php
   ...
   // Load Module Class  
   require_once $cfg->GetValue('app_module') . 'user/display/display_edit_biodata.class.php';
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
      ...
      if(!empty($_POST['simpan'])) {
         $update_mhs = $app->UpdateDataMhs($_POST['tanggal'],$_POST['alamat_asal'],$_POST['alamat_jogja'],$_POST['no_hp_mhs'],$_POST['jns_kelamin'],$userId);
         header("Location: " . $cfg->GetURL('user','profile','view'). '&err='. $errMsg);
         exit;
      }*/
      
      $ThisPage = new DisplayEditBiodata($cfg, $security, $userId, $userRole, $viewBy, $siaaddr);
