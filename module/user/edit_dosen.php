<?php
   ...
   // Load Module Class  
   require_once $cfg->GetValue('app_module') . 'user/display/display_edit_dosen.class.php';
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
      ...
      $ThisPage = new DisplayEditDosen($cfg, $security, $userId, $userRole, $viewBy, $siaaddr);
