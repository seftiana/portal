<?php
   ...
   // Load Module Class  
   require_once $cfg->GetValue('app_module') . 'user/display/display_edit_mahasiswa.class.php';
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
      ...
      // echo'role '.$userRole;
	  // print_r($_GET);
      $ThisPage = new DisplayEditMahasiswa($cfg, $security, $userId, $userRole, $viewBy, $siaaddr);
