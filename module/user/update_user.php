<?php
   ...
   // Load Module Class  
   require_once $cfg->GetValue('app_module') . 'user/display/display_update_user.class.php';
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
      ...
      $ThisPage = new DisplayUpdateUser($cfg, $security, $cfg->Dec($_REQUEST["id"]), $cfg->Dec($_REQUEST["key"]), $err);
