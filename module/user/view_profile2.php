<?php
   ...
   // Load Module Class  
   require_once $cfg->GetValue('app_module') . 'user/display/display_view_profile2.class.php';
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
      ...
      $ThisPage = new DisplayViewProfile2($cfg, $security, $userId, $userRole, $viewBy, $siaaddr);
