...
// Load Module Class  
require_once $cfg->GetValue('app_module') . 'wisuda/display/display_add_wisuda.class.php';
...
if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
	...
	if (isset($_GET["niu"])){
	  ...
	  // echo'role '.$userRole;
	  // print_r($_GET);
	$ThisPage = new DisplayAddWisuda($cfg, $security, $userId, $userRole, $viewBy, $siaaddr);
