<?php
   ...
   class UserClientService extends ServiceClient
   {
	...
	##modul portal wisuda add ccp 21-feb2024
	function GetWisudawan($tgl_wisuda){
        $tmp = array('pAct' => 'GetWisudawan');
        $this->mReqServiceParams = array_merge($this->mReqServiceParams, $tmp);
        $dataParams = array($this->GetProperty("UserId"), $this->GetProperty("UserRole"),$tgl_wisuda);
	...
	function GetDataTglWisuda() {
		$tmp = array('pAct' => 'GetDataTglWisuda');
        $this->mReqServiceParams = array_merge($this->mReqServiceParams, $tmp);
        $dataParams = array();
        $serviceParams = array($this->mReqServiceParams, $dataParams);
        $result = $this->Call("Dispatch", $serviceParams);
	...
	function GetIpkSksMhs($userId) {
		$tmp = array('pAct' => 'GetIpkSksMhs');
		$this->mReqServiceParams = array_merge($this->mReqServiceParams, $tmp);
		$dataParams = array($this->GetProperty("UserId"));
		$serviceParams = array($this->mReqServiceParams, $dataParams);
		$result = $this->Call("Dispatch", $serviceParams);
	...
	function DoInsertWisudaMhs($niu,$mhsData){
		$tmp = array('pAct' => 'DoInsertWisudaMhs');
		$this->mReqServiceParams = array_merge($this->mReqServiceParams, $tmp);
		$dataParams = array($niu,$mhsData);
		$serviceParams = array($this->mReqServiceParams, $dataParams);
		$result = $this->Call("Dispatch", $serviceParams);
	...
	function GetMwisudaMhs($userId) {
		$tmp = array('pAct' => 'GetMwisudaMhs');
		$this->mReqServiceParams = array_merge($this->mReqServiceParams, $tmp);
		//$dataParams = array($userId);
		$dataParams = array($this->GetProperty("UserId"), $this->GetProperty("UserRole"));
		$serviceParams = array($this->mReqServiceParams, $dataParams);
	...
	function DoUpdateWisudaMhs($niu,$mhsData){
		$tmp = array('pAct' => 'DoUpdateWisudaMhs');
		$this->mReqServiceParams = array_merge($this->mReqServiceParams, $tmp);
		$dataParams = array($niu,$mhsData);
		$serviceParams = array($this->mReqServiceParams, $dataParams);
		$result = $this->Call("Dispatch", $serviceParams);
	...
	function DoUpdateWisudaTiketAmbil($niu,$mhsData){
		$tmp = array('pAct' => 'DoUpdateWisudaTiketAmbil');
		$this->mReqServiceParams = array_merge($this->mReqServiceParams, $tmp);
		$dataParams = array($niu,$mhsData);
		$serviceParams = array($this->mReqServiceParams, $dataParams);
		$result = $this->Call("Dispatch", $serviceParams);
	...
	function GetWisudawanOld($tgl_wisuda){
        $tmp = array('pAct' => 'GetWisudawanOld');
        $this->mReqServiceParams = array_merge($this->mReqServiceParams, $tmp);
        $dataParams = array($this->GetProperty("UserId"), $this->GetProperty("UserRole"),$tgl_wisuda);
