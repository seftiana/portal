...
// Load Module Class  
require_once $cfg->GetValue('app_module') . 'wisuda/display/display_view_daftar.class.php';
...
if (false !== $security->CheckAccessRight($ThisPageAccessRight)){
	...
	$ThisPage = new DisplayViewDaftar($cfg, $security, $userId, $userRole, $viewBy, $siaaddr);
