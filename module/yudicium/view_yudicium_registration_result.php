...
//Load module Display Yudicium
   require_once $cfg->GetValue('app_module') . 'yudicium/display/display_view_yudicium_registration_result.class.php';
   ...
   if (false !== $security->CheckAccessRight($ThisPageAccessRight)) {
      ...
      if (isset($_GET["err"])){
		...
		$ThisPage = new DisplayViewYudiciumRegistrationResult($cfg, $security, $errMsg);
