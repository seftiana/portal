...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "docbkd_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "dokumen", "varname" => "docbkd_at_localhost__dokumen", "altvarname" => "dokumen", "connId" => "docbkd_at_localhost", "schema" => "", "connName" => "docbkd at localhost");
		}
		if( "bdr_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "tb_user", "varname" => "bdr_at_localhost__tb_user", "altvarname" => "tb_user", "connId" => "bdr_at_localhost", "schema" => "", "connName" => "bdr at localhost");
		}
	}
