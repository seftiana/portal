...
class ProjectSettings
{
	...
	*/
	...
	{
		return new ProjectSettings("tb_user", PAGE_LIST);
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "dokumen" ] = array( "url" => "dokumen", "type" => 0 );
	$projectEntitiesReverse[ "dokumen" ] = "dokumen";
	$projectEntities[ "tb_user" ] = array( "url" => "tb_user", "type" => 0 );
	$projectEntitiesReverse[ "tb_user" ] = "tb_user";
}
