...
class ConnectionManager
{
	...
	{
		return $this->byId( "docbkd_at_localhost" );
	}
	...
	{
		return $this->byId( "bdr_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "docbkd_at_localhost";
		$data["connName"] = "docbkd at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;docbkd;;1"; //currently unused

		$this->_connectionsIdByName["docbkd at localhost"] = "docbkd_at_localhost";
...
;
		...
		$connectionsData["docbkd_at_localhost"] = $data;
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "bdr_at_localhost";
		$data["connName"] = "bdr at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;bdr;;1"; //currently unused

		$this->_connectionsIdByName["bdr at localhost"] = "bdr_at_localhost";
...
;
		...
		$connectionsData["bdr_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["dokumen"] = "docbkd_at_localhost";
		$connectionsIds["tb_user"] = "bdr_at_localhost";
