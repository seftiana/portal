...
$layout = new TLayout("print_bootstrap", "OfficeCoral", "MobileCoral");
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "dokumen_print";
...
$page_layouts["dokumen_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "dokumen" );
