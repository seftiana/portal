...
function checkTableName($shortTName, $type=false)
{
	...
	if ("dokumen" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("tb_user" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	return false;
}
...
function AfterFBLogIn( $pUsername, $pPassword, $pDisplayUsername, &$pageObject = null)
{
	...
	$strSQL = "select * from ".$connection->addTableWrappers("tb_user")
