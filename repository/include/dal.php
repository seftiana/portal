...
function UsersTableName()
{
	...
	return $connection->addTableWrappers("tb_user");
}
...
class tDAL
{
	var $tbldocbkd_at_localhost__dokumen;
	var $tblbdr_at_localhost__tb_user;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "dokumen", "varname" => "docbkd_at_localhost__dokumen", "altvarname" => "dokumen", "connId" => "docbkd_at_localhost", "schema" => "", "connName" => "docbkd at localhost");
		$this->lstTables[] = array("name" => "tb_user", "varname" => "bdr_at_localhost__tb_user", "altvarname" => "tb_user", "connId" => "bdr_at_localhost", "schema" => "", "connName" => "bdr at localhost");
	}
