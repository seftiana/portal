...
require_once("include/tb_user_variables.php");
...
$layout = new TLayout("edit_bootstrap", "OfficeCoral", "MobileCoral");
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "tb_user_edit";
...
$page_layouts["tb_user_edit"] = $layout;
...
$layout = new TLayout("list_bootstrap1", "OfficeCoral", "MobileCoral");
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "tb_user_list";
...
$page_layouts["tb_user_list"] = $layout;
