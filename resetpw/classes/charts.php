...
// where tab
	...
	protected function isProjectDB()
	{
		...
		if("t_user" == $this->chrt_array['tables'][0])
			return true;
		if("t_unit" == $this->chrt_array['tables'][0])
			return true;
		if("program_studi" == $this->chrt_array['tables'][0])
			return true;
		if("t_hak_akses_ref" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
