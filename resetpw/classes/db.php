...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "gtportal_dev_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "fakultas", "varname" => "gtportal_dev_at_localhost__fakultas", "altvarname" => "fakultas", "connId" => "gtportal_dev_at_localhost", "schema" => "", "connName" => "gtportal_dev at localhost");
			$dalTables[$conn->connId][] = array("name" => "jenjang_akademik_ref", "varname" => "gtportal_dev_at_localhost__jenjang_akademik_ref", "altvarname" => "jenjang_akademik_ref", "connId" => "gtportal_dev_at_localhost", "schema" => "", "connName" => "gtportal_dev at localhost");
			$dalTables[$conn->connId][] = array("name" => "jurusan", "varname" => "gtportal_dev_at_localhost__jurusan", "altvarname" => "jurusan", "connId" => "gtportal_dev_at_localhost", "schema" => "", "connName" => "gtportal_dev at localhost");
			$dalTables[$conn->connId][] = array("name" => "model_ref", "varname" => "gtportal_dev_at_localhost__model_ref", "altvarname" => "model_ref", "connId" => "gtportal_dev_at_localhost", "schema" => "", "connName" => "gtportal_dev at localhost");
			$dalTables[$conn->connId][] = array("name" => "program_studi", "varname" => "gtportal_dev_at_localhost__program_studi", "altvarname" => "program_studi", "connId" => "gtportal_dev_at_localhost", "schema" => "", "connName" => "gtportal_dev at localhost");
			$dalTables[$conn->connId][] = array("name" => "t_hak_akses_ref", "varname" => "gtportal_dev_at_localhost__t_hak_akses_ref", "altvarname" => "t_hak_akses_ref", "connId" => "gtportal_dev_at_localhost", "schema" => "", "connName" => "gtportal_dev at localhost");
			$dalTables[$conn->connId][] = array("name" => "t_unit", "varname" => "gtportal_dev_at_localhost__t_unit", "altvarname" => "t_unit", "connId" => "gtportal_dev_at_localhost", "schema" => "", "connName" => "gtportal_dev at localhost");
			$dalTables[$conn->connId][] = array("name" => "t_user", "varname" => "gtportal_dev_at_localhost__t_user", "altvarname" => "t_user", "connId" => "gtportal_dev_at_localhost", "schema" => "", "connName" => "gtportal_dev at localhost");
		}
		if( "alluser_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "pengguna", "varname" => "alluser_at_localhost__pengguna", "altvarname" => "pengguna", "connId" => "alluser_at_localhost", "schema" => "", "connName" => "alluser at localhost");
		}
	}
