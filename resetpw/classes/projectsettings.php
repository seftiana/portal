...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "t_user" ] = array( "url" => "t_user", "type" => 0 );
	$projectEntitiesReverse[ "t_user" ] = "t_user";
	$projectEntities[ "t_unit" ] = array( "url" => "t_unit", "type" => 0 );
	$projectEntitiesReverse[ "t_unit" ] = "t_unit";
	$projectEntities[ "program_studi" ] = array( "url" => "program_studi", "type" => 0 );
	$projectEntitiesReverse[ "program_studi" ] = "program_studi";
	$projectEntities[ "t_hak_akses_ref" ] = array( "url" => "t_hak_akses_ref", "type" => 0 );
	$projectEntitiesReverse[ "t_hak_akses_ref" ] = "t_hak_akses_ref";
}
