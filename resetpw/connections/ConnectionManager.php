...
class ConnectionManager
{
	...
	{
		return $this->byId( "gtportal_dev_at_localhost" );
	}
	...
	{
		return $this->byId( "alluser_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "gtportal_dev_at_localhost";
		$data["connName"] = "gtportal_dev at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;gtportal_dev;;1"; //currently unused

		$this->_connectionsIdByName["gtportal_dev at localhost"] = "gtportal_dev_at_localhost";
...
;
		...
		$connectionsData["gtportal_dev_at_localhost"] = $data;
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "alluser_at_localhost";
		$data["connName"] = "alluser at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;alluser;;1"; //currently unused

		$this->_connectionsIdByName["alluser at localhost"] = "alluser_at_localhost";
...
;
		...
		$connectionsData["alluser_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["t_user"] = "gtportal_dev_at_localhost";
		$connectionsIds["t_unit"] = "gtportal_dev_at_localhost";
		$connectionsIds["program_studi"] = "gtportal_dev_at_localhost";
		$connectionsIds["t_hak_akses_ref"] = "gtportal_dev_at_localhost";
