...
class tDAL
{
	var $tblgtportal_dev_at_localhost__fakultas;
	var $tblgtportal_dev_at_localhost__jenjang_akademik_ref;
	var $tblgtportal_dev_at_localhost__jurusan;
	var $tblgtportal_dev_at_localhost__model_ref;
	var $tblgtportal_dev_at_localhost__program_studi;
	var $tblgtportal_dev_at_localhost__t_hak_akses_ref;
	var $tblgtportal_dev_at_localhost__t_unit;
	var $tblgtportal_dev_at_localhost__t_user;
	var $tblalluser_at_localhost__pengguna;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "fakultas", "varname" => "gtportal_dev_at_localhost__fakultas", "altvarname" => "fakultas", "connId" => "gtportal_dev_at_localhost", "schema" => "", "connName" => "gtportal_dev at localhost");
		$this->lstTables[] = array("name" => "jenjang_akademik_ref", "varname" => "gtportal_dev_at_localhost__jenjang_akademik_ref", "altvarname" => "jenjang_akademik_ref", "connId" => "gtportal_dev_at_localhost", "schema" => "", "connName" => "gtportal_dev at localhost");
		$this->lstTables[] = array("name" => "jurusan", "varname" => "gtportal_dev_at_localhost__jurusan", "altvarname" => "jurusan", "connId" => "gtportal_dev_at_localhost", "schema" => "", "connName" => "gtportal_dev at localhost");
		$this->lstTables[] = array("name" => "model_ref", "varname" => "gtportal_dev_at_localhost__model_ref", "altvarname" => "model_ref", "connId" => "gtportal_dev_at_localhost", "schema" => "", "connName" => "gtportal_dev at localhost");
		$this->lstTables[] = array("name" => "program_studi", "varname" => "gtportal_dev_at_localhost__program_studi", "altvarname" => "program_studi", "connId" => "gtportal_dev_at_localhost", "schema" => "", "connName" => "gtportal_dev at localhost");
		$this->lstTables[] = array("name" => "t_hak_akses_ref", "varname" => "gtportal_dev_at_localhost__t_hak_akses_ref", "altvarname" => "t_hak_akses_ref", "connId" => "gtportal_dev_at_localhost", "schema" => "", "connName" => "gtportal_dev at localhost");
		$this->lstTables[] = array("name" => "t_unit", "varname" => "gtportal_dev_at_localhost__t_unit", "altvarname" => "t_unit", "connId" => "gtportal_dev_at_localhost", "schema" => "", "connName" => "gtportal_dev at localhost");
		$this->lstTables[] = array("name" => "t_user", "varname" => "gtportal_dev_at_localhost__t_user", "altvarname" => "t_user", "connId" => "gtportal_dev_at_localhost", "schema" => "", "connName" => "gtportal_dev at localhost");
		$this->lstTables[] = array("name" => "pengguna", "varname" => "alluser_at_localhost__pengguna", "altvarname" => "pengguna", "connId" => "alluser_at_localhost", "schema" => "", "connName" => "alluser at localhost");
	}
